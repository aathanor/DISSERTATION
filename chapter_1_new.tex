...
\noindent\begin{minipage}{\dimexpr\textwidth+\notesmargin\relax}
  ...
  \noindent{\sffamily\Large\bfseries Chapter 1 --- Introduction}%
  \hfill{\sffamily\normalsize 2026-04-18}

    \vspace{2pt}
  \noindent{\sffamily\small\itshape Draft incorporating consolidation note and ToC observations}
