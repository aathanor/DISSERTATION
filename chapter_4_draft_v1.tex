...
\noindent\begin{minipage}{\dimexpr\textwidth+\notesmargin\relax}
  ...
  \noindent{\sffamily\Large\bfseries Chapter 4 --- The Functional-Mode Distinction}%
  \hfill{\sffamily\normalsize 2026-05-22}

    \vspace{2pt}
  \noindent{\sffamily\small\itshape PRU's Cognitive Vocabulary for Rigid Designation}
...
\section{\texorpdfstring{The \(x^o/x^c\) Functional-Mode Distinction}{The x\^{}o/x\^{}c Functional-Mode Distinction}}\label{the-xoxc-functional-mode-distinction}
...
\section{\texorpdfstring{\(\mathcal{R}\) as Coordination}{\textbackslash mathcal\{R\} as Coordination}}\label{mathcalr-as-coordination}
...
\section{\texorpdfstring{Local Rigidity at \(x^o\)}{Local Rigidity at x\^{}o}}\label{local-rigidity-at-xo}
...
\section{\texorpdfstring{De Re and De Dicto as Predication at \(x^o\) and \(x^c\)}{De Re and De Dicto as Predication at x\^{}o and x\^{}c}}\label{de-re-and-de-dicto-as-predication-at-xo-and-xc}
...
\section{The Necessary A Posteriori at the Level Distinction}\label{the-necessary-a-posteriori-at-the-level-distinction}
