...
- 4.1 — Two Modes of One Word (developmental evidence)
- 4.2 — The Distinction Applied to Identity ($x^o$: nonsense or trivial; $x^c$: substantive)
- 4.3 — Rigidity as a Property of $x^o$-mode Designation
- 4.4 — Names as the $x^o$ / $x^c$ Interface (Benjamin Franklin$^o$ vs. Benjamin Franklin$^c$)
- 4.5 — Local Rigidity as the Primitive Form of Reference
