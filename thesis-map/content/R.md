---
title: "$\mathcal{R}$ — the grounding operator"
kind: "PRU notation"
...
In baptism: $\mathcal{R}(h^o, N^c)$ — a human in object-mode, anchored, gets lifted into a name-concept. The name inherits the rigidity of the demonstrative act.

(In the PRU framework paper, $\mathcal{R}$ also has a formal characterization as a projective operator with non-commutative properties. This is parked: not needed in the dissertation unless an objector pushes on the formal nature.)
